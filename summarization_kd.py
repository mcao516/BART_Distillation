...
"""
Perform know distillation on summarization.
"""
...
def load_pretrained_model_and_tokenizer(
    ...
    if load_pretrained_model and model_name_or_path:
...
def main():
    ...
    # Prepare optimizer
    optimizer = setup_optimizer(args, student_model)

    # Prepare everything with our `accelerator`.
    model, student_model, optimizer, train_dataloader, eval_dataloader = accelerator.prepare(
        model, student_model, optimizer, train_dataloader, eval_dataloader
    )
